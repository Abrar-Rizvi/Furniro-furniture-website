...
import Kallu from "../components/Kallu";
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Card />
      <Product />
      {/* <div className="p-10 gap-x-3   flex justify-center items-center bg-blue-400">
        {users.map((user, idx) => {
             return  <Kallu  key={idx} user={user.name} city={user.city} age={user.profession} photo={user.profile_photo}     />
        })}
      </div> */}
    </div>
  );
